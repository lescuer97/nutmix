...
func KeysetsPage(mint *m.Mint) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err := templates.KeysetsPage(availableUnits, lightning.IsBackendEndOfLife(mint.LightningBackend), showLDKNodeLink(mint), ldkAlertMessage(mint)).Render(ctx, c.Writer)
