...
func (m MockDB) UpdateSeedEncryption(seed cashu.Seed) error {
	return nil
}
...
func (m MockDB) ModifyQuoteMintMintedStatus(minted bool, state cashu.ACTION_STATE, quote string) error {
	return nil
}
...
func (m MockDB) ModifyQuoteMeltMeltedStatus(melted bool, quote string) error {
	return nil
